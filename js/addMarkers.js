  ...
  init: async function () {
    ...
    dishes.map(dish => {
      ...
      if (!dish.unavailable_days.includes(days[todaysDay])) {
        ...
        dishTitle.setAttribute("id", `-title-${toy.id}`);
        ...
        caution.setAttribute("id", `caution-${toy.id}`);
        caution.setAttribute("position", { x: 0.3, y: 0, z: 0.1 });
        caution.setAttribute("rotation", { x: 0, y: 0, z: 0 });
        caution.setAttribute("text", {
          font: "monoid",
          color: "black",
          width: 2,
          align: "left",
